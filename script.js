...
// Company and Survey Data with PINs
const companyData = {
    upfield: {
        name: 'Upfield',
        pin: '1234',
        surveys: [
            {
                id: 'upfield-product-feedback',
                title: 'Product Feedback Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our plant-based products?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which of our product categories do you purchase most frequently?',
                        options: ['Margarine', 'Plant-based spreads', 'Cooking oils', 'Dairy alternatives'],
                        type: 'multiple_choice'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        options: ['Better taste', 'More variety', 'Lower price', 'Healthier ingredients'],
                        type: 'multiple_choice'
                    },
                    {
    ...
    reedemers: {
        ...
        surveys: [
            {
                id: 'reedemers-financial-services',
                ...
                questions: [
                    ...
                    {
                        question: 'Which financial service do you use most?',
                        options: ['Savings accounts', 'Investment services', 'Loans', 'Insurance'],
                        type: 'multiple_choice'
                    },
                    {
                    ...
                    {
                        question: 'What additional services would you like us to offer?',
                        options: ['Digital banking', 'Mobile apps', 'Financial planning', 'Cryptocurrency'],
                        type: 'multiple_choice'
                    },
                    {
    ...
    nnpc: {
        ...
        surveys: [
            {
                id: 'nnpc-energy-services',
                title: 'Energy Services Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our energy services?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which energy service is most important to you?',
                        options: ['Oil supply', 'Gas distribution', 'Refining services', 'Petrochemicals'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our reliability?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What environmental initiatives are most important?',
                        options: ['Carbon reduction', 'Renewable energy', 'Waste management', 'Water conservation'],
                        type: 'multiple_choice'
                    },
                    {
    ...
    ison: {
        ...
        surveys: [
            {
                id: 'ison-tech-solutions',
                title: 'Technology Solutions Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our technology solutions?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which technology service do you use most?',
                        options: ['Software development', 'IT consulting', 'Cloud services', 'Digital transformation'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our technical support?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What new technologies would you like us to offer?',
                        options: ['AI/ML solutions', 'Blockchain', 'IoT services', 'Cybersecurity'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional feedback:',
    ...
    ftn: {
        ...
        surveys: [
            {
                id: 'ftn-fintech-services',
                title: 'FinTech Services Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our FinTech services?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which FinTech service do you use most?',
                        options: ['Digital payments', 'Mobile banking', 'Investment platforms', 'Cryptocurrency services'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our app performance?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What security features are most important?',
                        options: ['Two-factor authentication', 'Biometric login', 'Encryption', 'Fraud detection'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional feedback:',
    ...
    suntory: {
        ...
        surveys: [
            {
                id: 'suntory-beverage-survey',
                title: 'Beverage Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our beverages?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which beverage category do you prefer?',
                        options: ['Whisky', 'Beer', 'Soft drinks', 'Tea/coffee'],
                        type: 'multiple_choice'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        options: ['Limited editions', 'Seasonal flavors', 'Health-focused', 'Premium options'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional comments:',
    ...
    tgi: {
        ...
        surveys: [
            {
                id: 'tgi-investment-survey',
                title: 'Investment Services Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our investment services?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which investment type interests you most?',
                        options: ['Stocks', 'Bonds', 'Real estate', 'Alternative investments'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our investment advice?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What investment tools would be most helpful?',
                        options: ['Portfolio analysis', 'Market research', 'Risk assessment', 'Educational resources'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional feedback:',
    ...
    friesland: {
        ...
        surveys: [
            {
                id: 'friesland-dairy-survey',
                title: 'Dairy Products Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our dairy products?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which dairy product do you consume most?',
                        options: ['Milk', 'Cheese', 'Yogurt', 'Butter'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our product freshness?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What health benefits are most important?',
                        options: ['Protein content', 'Calcium', 'Probiotics', 'Low fat'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional comments:',
    ...
    guiness: {
        ...
        surveys: [
            {
                id: 'guinness-brewing-survey',
                title: 'Brewing Company Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our beer products?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which beer style do you prefer?',
                        options: ['Stout', 'Lager', 'Ale', 'Specialty beers'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our beer quality?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What new beer varieties would you like?',
                        options: ['Seasonal brews', 'Limited editions', 'Craft collaborations', 'Low-alcohol options'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional comments:',
    ...
    unilever: {
        ...
        surveys: [
            {
                id: 'unilever-consumer-survey',
                title: 'Consumer Goods Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our consumer products?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which product category do you use most?',
                        options: ['Personal care', 'Home care', 'Food & beverages', 'Beauty products'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our product innovation?',
                        options: ['Excellent', 'Good', 'Fair', 'Poor'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'What sustainability features matter most?',
                        options: ['Eco-friendly packaging', 'Natural ingredients', 'Carbon footprint', 'Recycling programs'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional feedback:',
        ...
        surveys: [
            {
                ...
                questions: [
                    ...
                    {
                        question: 'Which beer style do you prefer?',
                        options: ['Lager', 'Stout', 'Ale', 'Specialty beers'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our beer quality?',
    ...
    nestle: {
        ...
        surveys: [
            {
                id: 'nestle-food-survey',
                title: 'Food & Beverage Survey',
                questions: [
                    {
                        question: 'How satisfied are you with our food products?',
                        options: ['Very Satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Which food category do you consume most?',
                        options: ['Chocolate & confectionery', 'Coffee & beverages', 'Dairy products', 'Prepared foods'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'How would you rate our product quality?',
                    ...
                    {
                        question: 'What health features are most important?',
                        options: ['Nutritional value', 'Allergen-free', 'Organic options', 'Portion control'],
                        type: 'multiple_choice'
                    },
                    {
                        question: 'Additional comments:',
...
// Company selection functionality for companies page
document.addEventListener('DOMContentLoaded', () => {
